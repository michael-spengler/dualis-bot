...
[
  ...
  Deno.test(testcase.name, async () => {
    ...
    if (testcase.success) {
      ...
      assertSpyCall(res.setStatus as Spy<any>, 0, {
        args: [testcase.expectedStatus],
      });
    ...
    MockCollection.initMock({
      ...
      updateOne: async (
        ...
        if (
          ...
          update?.$set?.dualis_password == "d93757eea53cf23bd810f1d332296912" &&
          update?.$set?.dualis_username == "d93757eea53cf23bd810f1d332296912" &&
          update?.$set?.username == "d93757eea53cf23bd810f1d332296912" &&
