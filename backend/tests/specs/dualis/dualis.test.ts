import { assert, assertEquals, assertSpyCall, assertSpyCallAsync } from "../../test_deps.ts"
import { compareExaminations, cronjob, getDualisChanges } from "../../../dualis/dualis.ts"
